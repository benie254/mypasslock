...
def main():
    ...
    while True:
        ...
        if short_code == 'se':
            ...
            print(f'Existing Account {ex_acc_name} for username: {ex_acc_user} saved')
            ...
            while True:
                ...
                print('Enter CP to Create an account password ...\
                        Enter GP to Generate an account password')
            ...
            print(f'New Account {acc_name} for username: {acc_user} created')
            ...
            while True:
                ...
                if user_code == 'y':
                    ...
                    if find_account(del_id):
                        ...
                        print(f"Your account {search_account.account_name} has been deleted")
